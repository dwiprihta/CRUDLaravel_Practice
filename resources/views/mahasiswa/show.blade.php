...
<div class="container pt-5">
    <div claass="row">
        ...
        <div class="card" style="width: 100%;">
            <div class="card-body">
                 <h5 class="card-title">BIODATA MAHASISWA</h5><hr>
                 <ul class="list-group">
                    <li class="list-group-item active">BIODATA {{$mahasiswa->nama}}</li>
                    <li class="list-group-item">{{$mahasiswa->nim}}</li>
                    <li class="list-group-item">{{$mahasiswa->nama}}</li>
                    <li class="list-group-item">{{$mahasiswa->jenis_kelamin}}</li>
